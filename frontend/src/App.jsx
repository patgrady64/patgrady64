        ...
        <div className='max-w-6xl mx-auto relative z-10 flex flex-col md:flex-row md:items-center md:justify-between gap-8'>
          <div className='max-w-2xl text-center md:text-left'>
            ...
            <p className='text-gray-400 mt-6 leading-relaxed text-base md:text-lg max-w-xl'>
              Building dynamic full-stack infrastructure and highly optimized
              mobile applications. Focused on algorithmic structural execution
            ...
            <p className='text-gray-400 mt-3 leading-relaxed text-base md:text-lg max-w-xl'>
              ...
              architecture—analyzing routing logic, seed pacing, and combat
              mechanics for{' '}
              <span className='text-amber-400 font-medium'>Zelda 1</span> and{' '}
            ...
            <div className='flex flex-wrap items-center justify-center md:justify-start gap-4 mt-8'>
              ...
              >
                <FontAwesomeIcon icon={faYoutube} className='text-lg' /> YouTube
                Channel
              </a>
            </div>
          </div>
          ...
          <div className='w-full md:w-80 bg-gray-950/40 border border-gray-800 rounded-2xl p-6 backdrop-blur-md shadow-2xl self-start md:self-auto'>
            ...
            <ul className='space-y-3 font-mono text-xs'>
              <li className='flex justify-between'>
                ...
                <span className='text-emerald-400'>AI & Software Eng.</span>
              </li>
              <li className='flex justify-between'>
                <span className='text-gray-500'>Frameworks:</span>{' '}
                <span className='text-slate-300'>React, Flask, Supabase</span>
              </li>
              <li className='flex justify-between'>
              ...
              <li className='flex justify-between pt-2 border-t border-gray-800/40 relative before:absolute before:top-0 before:left-0 before:w-full before:h-px before:bg-gradient-to-r before:from-transparent before:via-emerald-500/20 before:to-transparent'>
      ...
      <main className='max-w-6xl mx-auto px-6 py-16 space-y-20'>
          ...
          <div className='flex flex-col sm:flex-row sm:items-center justify-between gap-2 mb-10 border-b border-gray-800 pb-4'>
            <div>
              ...
              <p className='text-sm text-gray-500 mt-1'>
                Dynamic applications synced directly via Supabase & Flask API
                architecture
              </p>
            </div>
          ...
          {loading ? (
            <div className='flex flex-col items-center justify-center py-20 bg-gray-950/20 border border-gray-800/60 rounded-2xl border-dashed'>
              ...
              <p className='text-sm text-gray-500 mt-4 font-mono'>
                Querying cloud environment payload tables...
              </p>
            </div>
          ) : (
            <div className='grid md:grid-cols-2 gap-8'>
              {projects.map(project => (
                <div
                  key={project.id}
                  className='group relative rounded-3xl border border-gray-800/60 bg-gradient-to-b from-gray-950 via-gray-900/80 to-gray-950 shadow-xl transition-all duration-300 hover:-translate-y-1 hover:shadow-emerald-500/10 overflow-hidden flex flex-col justify-between p-6'
                >
                  ...
                  <div>
                    <div className='flex items-start justify-between gap-4'>
                      <h3 className='text-2xl font-bold text-white tracking-tight group-hover:text-emerald-300 transition-colors duration-200'>
                        {project.title}
                      </h3>
                    ...
                    <p className='text-sm text-gray-300 mt-3 leading-relaxed max-w-prose'>
                      {project.description}
                    </p>
                  ...
                  {/* FIX: This closing div was missing, wrapping the upper block */}
                  ...
                  <div className='mt-8 pt-5 border-t border-gray-800/60 flex items-center justify-between gap-4'>
                    {project.gif_url ? (
                      <div className='relative w-20 h-20 rounded-2xl overflow-hidden border border-gray-800 group-hover:border-emerald-500/30 transition'>
                        <img
                          src={project.gif_url}
                          alt='App Walkthrough Preview'
                    ...
                    <div className='flex items-center gap-2.5'>
                      ...
                      {project.download_url && (
                        <a
                          ...
                          className='px-3 py-2 text-xs rounded-xl border border-gray-700 text-gray-300 hover:text-white hover:border-gray-500 hover:bg-white/5 transition'
                        >
        ...
        <section>
          <div className='mb-10 border-b border-gray-800 pb-4'>
            <h2 className='text-2xl font-bold text-white tracking-tight flex items-center gap-3'>
              <Tv className='text-purple-400 stroke-[2.5]' size={22} /> Media &
              Structural Analysis Hub
            </h2>
            <p className='text-sm text-gray-500 mt-1'>
              Video captures, algorithmic run optimization, and live broadcast
              logs
            </p>
          </div>
            ...
            <div className='bg-gradient-to-b from-gray-900 to-gray-950 border border-gray-800 rounded-2xl p-6 shadow-xl space-y-6'>
              <div>
                ...
                <p className='text-xs text-gray-400 mt-3 leading-relaxed'>
                  Gameplay capture sequences run on a localized, silent system
                  environment. Broadcast audio records core execution routing,
                  tracking optimization paths and live speed metrics cleanly.
                </p>
              </div>
